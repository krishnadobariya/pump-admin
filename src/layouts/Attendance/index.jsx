...
import { getAllAttendanceAction } from "store/Action/attendanceAction";
...
function Assets() {
    ...
    const columns = [
        { name: "Name", align: "left", backname: "userName" },
            ...
            <SoftBox py={3} sx={{ minHeight: "80vh" }}>
                <SoftBox mb={3}>
                    <Card>
                        ...
                        >
                            <Table columns={columns} rows={attendanceGet?.attendanceGet?.data} mangerById={mangerById} setManagerById={setManagerById} handleOpen={handleOpen} handleOpenDel={handleOpenDel} />
                        </SoftBox>
                    </Card>
                </SoftBox>
